...
INSERT INTO posts (
  ...
  ('p4', 'Corn pest infestation detected', 'Found significant pest damage in the eastern field. Immediate treatment recommended.', 'Corn', 'Pest', 5, 'Public', 42.3601, -71.0589, 'Boston', (EXTRACT(EPOCH FROM NOW()) * 1000)::BIGINT - 7200000, 15, 'u3', '/blueberries.jpg'),
  ('p5', 'Fresh blueberries at local market', 'Selling freshly picked organic blueberries at the Saturday farmers market.', 'Blueberries', 'Market', 1, 'Public', 42.3601, -71.0589, 'Boston', (EXTRACT(EPOCH FROM NOW()) * 1000)::BIGINT - 2700000, 7, 'u1', '/blueberries.jpg')
ON CONFLICT (id) DO NOTHING;
